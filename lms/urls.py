...
urlpatterns = [
    ...
    path('debug/', include('lms.djangoapps.session_fix.urls')),
...
if settings.DEBUG:
    ...
    def test_simple_login_view(request):
        """Serve the simple login test page"""
        with open('/home/suriya-vcw/Desktop/suriya work/edx-platform/test_simple_login.html', 'r') as f:
            content = f.read()
        return HttpResponse(content, content_type='text/html')
    
    def test_traditional_login_view(request):
        """Serve the traditional login test page"""
        with open('/home/suriya-vcw/Desktop/suriya work/edx-platform/test_traditional_login.html', 'r') as f:
            content = f.read()
        return HttpResponse(content, content_type='text/html')
    
    def test_session_debug_view(request):
        """Serve the session debug test page"""
        with open('/home/suriya-vcw/Desktop/suriya work/edx-platform/test_session_debug.html', 'r') as f:
            content = f.read()
        return HttpResponse(content, content_type='text/html')
    
    urlpatterns += [
        path('test_simple_login.html', test_simple_login_view),
        path('test_traditional_login.html', test_traditional_login_view),
        path('test_session_debug.html', test_session_debug_view),
    ]
