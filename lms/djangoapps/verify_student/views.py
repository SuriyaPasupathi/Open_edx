...
class PayAndVerifyView(View):
    ...
    * How the user reached the page (mostly affects messaging)
    ...
    def get(  # lint-amnesty, pylint: disable=too-many-statements
        ...
        # Auto-enroll in verified mode and mark as paid if user is verified
        # This bypasses payment requirement for verified users
        if already_verified and not already_paid and CourseMode.is_verified_mode(relevant_course_mode):
            from common.djangoapps.student.models import CourseEnrollment
