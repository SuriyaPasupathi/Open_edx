...
MIDDLEWARE = [
    ...
    'lms.djangoapps.session_fix.middleware.SessionCookieFixMiddleware',
...
RATELIMIT_ENABLE = False  # DISABLED: Rate limiting disabled for FastAPI integration
...
# DISABLED: Rate limits increased significantly for FastAPI integration
LOGISTRATION_RATELIMIT_RATE = '10000/5m'  # Increased from 100/5m
LOGISTRATION_PER_EMAIL_RATELIMIT_RATE = '10000/5m'  # Increased from 30/5m
LOGISTRATION_API_RATELIMIT = '10000/m'  # Increased from 20/m
LOGIN_AND_REGISTER_FORM_RATELIMIT = '10000/5m'  # Increased from 100/5m
RESET_PASSWORD_TOKEN_VALIDATE_API_RATELIMIT = '10000/7d'  # Increased from 30/7d
RESET_PASSWORD_API_RATELIMIT = '10000/7d'  # Increased from 30/7d
OPTIONAL_FIELD_API_RATELIMIT = '10000/h'  # Increased from 10/h

##### PASSWORD RESET RATE LIMIT SETTINGS #####
# DISABLED: Rate limits increased significantly for FastAPI integration
PASSWORD_RESET_IP_RATE = '10000/m'  # Increased from 1/m
PASSWORD_RESET_EMAIL_RATE = '10000/h'  # Increased from 2/h
